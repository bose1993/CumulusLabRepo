 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="operationInvocation" type="{http://www.cumulus.org/certificate/model}OperationRefType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="assignment" type="{http://www.cumulus.org/certificate/model}AssignmentType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class ActionType {
    ...
    protected List<OperationRefType> operationInvocation;
     ...
     * 
     */
    public List<OperationRefType> getOperationInvocation() {
        if (operationInvocation == null) {
            operationInvocation = new ArrayList<OperationRefType>();
        }
