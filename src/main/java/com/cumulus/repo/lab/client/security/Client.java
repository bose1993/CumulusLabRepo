...
public class Client {
	...
	public String doPOSTConnection(String URLtoGet,String json) throws ConnectionFailedException{
		 URL url;
	      HttpURLConnection conn = null;
	      BufferedReader rd;
	      String line;
	...
	public String doPOSTConnection(String URLtoGet,Map<?,?> map) throws ConnectionFailedException{
		 URL url;
	      HttpURLConnection conn = null;
	      BufferedReader rd;
	      String line;
