...
public class ClientAuthenticator {
    private final Logger log = LoggerFactory.getLogger(ClientAuthenticator.class);
	...
	public ClientAuthenticator(String URL,String username, String password,String client_id,String client_secret) throws ConnectionFailedException {
		this.targetURL=URL;
	...
	public String takeToken() throws ConnectionFailedException{
		 URL url;
		    ...
		    try {
		      ...
		      if (!(code>=200 && code<=299)){
			      ...
			      ConnectionFailedException e =  new ConnectionFailedException("Can not contact the authentication server. Error Code: "+String.valueOf(code)+" Message: "+ response.toString());
		...
		public Token getToken() throws UnauthorizedAccessException {
			if(this.token==null){
